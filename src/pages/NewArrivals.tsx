  ...
  return (
    <>
      <MetaData
        ...
        description='Découvrez les derniers équipements dentaires ajoutés à notre catalogue, alliant innovation et qualité pour répondre aux besoins des professionnels.'
      >
        {/* Open Graph / Facebook */}
        <meta
          property='og:title'
          content='Nouveaux Arrivages - Dental Supply'
        />
        <meta
          property='og:description'
          content='Découvrez les derniers équipements dentaires ajoutés à notre catalogue, alliant innovation et qualité pour répondre aux besoins des professionnels.'
        />
        <meta
          property='og:type'
          content='website'
        ...
        <meta
          property='og:url'
          content='https://dental-supply.netlify.app/nouveaux-arrivages'
        />
        <meta
          property='og:image'
        ...
        <meta
          name='keywords'
          content='nouveaux arrivages, équipements dentaires, fournitures dentaires, Dental Supply, nouveaux produits dentaires'
        />
        {/* Robots */}
        <meta
          name='robots'
        ...
        <link
          rel='canonical'
          href='https://dental-supply.netlify.app/nouveaux-arrivages'
        />
      </MetaData>
      <section>
        <div className='container'>
          ...
          <p className='text-gray-500 mb-4 max-w-3xl'>
            Découvrez les derniers équipements dentaires ajoutés à notre
            catalogue, alliant innovation et qualité pour répondre aux besoins
            des professionnels.
          </p>
