...
const Register = () => {
  return (
    <>
      <PageTitle title='Créer un compte' content='Inscrivez-vous pour accéder à votre espace personnel, gérer vos commandes et profiter de nos services dédiés aux professionnels du secteur dentaire.' />
